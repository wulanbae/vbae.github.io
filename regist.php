            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="dashboard.php" class="logo d-flex align-items-center w-auto">
                  <span class="d-none d-lg-block">ABUL WEB</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="regis.php" method="POST" class="row g-3 needs-validation" novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <label for="confirmPassword" class="form-label">Ulang Password</label>
                      ...
                      document.addEventListener("DOMContentLoaded", function() {
                        ...
                        confirmPasswordInput.addEventListener("input", function() {
                          if (passwordInput.value !== confirmPasswordInput.value) {
                            confirmPasswordInput.setCustomValidity("Password harus sama dengan Ulang Password");
                          } else {
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="level" class="form-control" id="yourLevel" required>
              ...
              <div class="credits">
                ...
                Designed by <a href="https://bootstrapmade.com/">abul</a>
              </div>
